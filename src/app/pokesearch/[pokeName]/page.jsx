        ...
        <div className='shadow-md p-10 rounded-md'>
          {loading ? (
            ...
            <>
              ...
              <Image src = {pokeData.sprites?.other.home.front_default} width = {300} height = {300} alt = "poke name"></Image>
              <div className='mt-5'>
                <p className='my-3'>Weight : {pokeData.weight}</p>
                <p className='my-3'>
                  Abilities: {" "}
                  {pokeData.abilities?.map(val => (
                    <span key = {val.ability.name} className='bg-gray-500 text-white px-2 py-1 rounded-md mr-1.5'>{val.ability.name}</span>
                  ))}
                </p>
                ...
                <p className='my-3'>
                  ...
                  {pokeData.types?.map(val => (
                    <span key = {val.type.name} className='bg-gray-500 text-white px-2 py-1 rounded-md mr-1.5'>{val.type.name}</span>
                  ))}
                </p>
              </div>
